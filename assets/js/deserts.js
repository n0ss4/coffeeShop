    ...
    function renderizarProductos() {
        baseDeDatos.forEach((info) => {
            if(info.categoria=='altres'){
                ...
                dessert.addEventListener('click', showModal);
                dessert.classList.add('card', 'card-top', 'col-xxl-3', 'col-xl-4', 'col-lg-6', 'col-md-6', 'col-12', 'd-flex', 'flex-column', 'mb-2');
                    ...
                    dessert_body.style.pointerEvents = 'none';
                        ...
                        dessert_body_left.style.pointerEvents = 'none';
                            ...
                            dessert_body_left_p.style.pointerEvents = 'none';
                            ...
                            dessert_body_left_span.style.pointerEvents = 'none';
                        ...
                        dessert_body_right.style.pointerEvents = 'none';
                            ...
                            dessert_body_right_button.setAttribute('type', 'button');
                            dessert_body_right_button.setAttribute('marcador', info.id);
                            $(dessert_body_right_button).on("click", addProductToCart);
                            dessert_body_right_button.style.pointerEvents = 'auto';
                                ...
                                dessert_body_right_button_i.style.pointerEvents = 'none';
